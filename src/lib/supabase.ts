...
// Keep this type in sync with packages/core/src/lib/supabase.ts (the canonical source).
// It is duplicated here to avoid cross-workspace generic-inference issues with tsc -b.
//
