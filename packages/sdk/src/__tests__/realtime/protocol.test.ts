...
describe('PROTOCOL table', () => {
  const SAMPLE_EVENTS: NetEvent[] = [
    ...
    { kind: 'whiteboard:clear', v: 1, actorId: 'a', seq: 1, t: 0, epoch: 1 },
    { kind: 'whiteboard:undo', v: 1, actorId: 'a', seq: 1, t: 0, strokeId: 's' },
    {
      kind: 'shot:hit',
      v: 1,
      actorId: 'a',
    ...
    { kind: 'loot:open', v: 1, actorId: 'a', seq: 1, t: 0, itemId: 'sword' },
    {
      kind: 'zombie:state',
      v: 1,
      actorId: 'host',
    ...
    { kind: 'screen:stop', v: 1, actorId: 'a', seq: 1, t: 0 },
    {
      kind: 'bubble:prefs',
      v: 1,
      actorId: 'a',
      seq: 1,
      t: 0,
      prefs: { radius: 3, visible: true },
    },
    { kind: 'net:ping', v: 1, actorId: 'a', seq: 1, t: 0, nonce: 'n1' },
    { kind: 'net:pong', v: 1, actorId: 'a', seq: 1, t: 0, nonce: 'n1' },
